        ...
        <div class="col">
            <div class="card">
                ...
                <div class="col-lg-12">
                    ...
                    <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#tambahpegawaimodal"><i class="fa fa-plus"></i> Tambah Admin</button>
            ...
            <div class="modal-body">
                <form action="<?= base_url() ?>admin/tambah_pegawai" method="POST">
                    <div class="form-group">
                        ...
                        <label>Alamat</label>
                        <input type="text" class="form-control" placeholder="Jl.Slamet Riyadi Surakarta" name="alamat" required>
                        <label>Telepon</label>
                        <input type="text" class="form-control" placeholder="081227110121" name="telepon" required>
                    </div>
            </div>
...
<div class="modal fade" id="editpasswordmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Change Password Admin <span id="nama_title"></span></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
