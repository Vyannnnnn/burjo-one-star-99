  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Burjo One Star 99<strong>
        <br>
        <span>Kelompok 9</span></strong>
        <br>Varindra Kiaranova Nugroho 21.12.1916
        <br>Achmad Noor Seta 21.12.1956
        <br>Ahmad Andre Alfiansyah 21.12.1968
        <br>Alif Naufal Muhammad Yusuf 21.12.1973
      </div>
    </div>
  </footer><!-- End Footer -->
