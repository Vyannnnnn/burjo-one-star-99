    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="<?= base_url() ?>katalog">Menu</a></li>
          <li><a href="<?= base_url() ?>home/booking">Pesan Sekarang</a></li>
          <li><a href="<?= base_url() ?>pembayaran/cari">Transaksi</a></li>
          <li><a href="<?= base_url() ?>auth/loginPegawai">Login</a></li>
        </ul>
